...
class Validate {
    ...
    static string(arg, name) {
        index_1.Logger.internal.verbose('Validate.string');
    ...
    static object(arg, name) {
        index_1.Logger.internal.verbose('Validate.object');
        Validate.parameters([arg, name], 2);
    ...
    static number(arg, name) {
        index_1.Logger.internal.verbose('Validate.number');
        Validate.parameters([arg, name], 2);
