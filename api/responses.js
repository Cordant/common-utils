...
class Responses {
    ...
    static error(statusCode, message, data) {
        ...
        index_1.Logger.error(statusCode, response);
        return response;
    }
    static response(statusCode, message, data) {
        index_1.Logger.verbose('Responses.response');
        if (data) {
            index_1.Logger.verbose('Returning body with the data parameter!');
            return {
        ...
        index_1.Logger.verbose('Returning body without the data parameter!');
        return {
            statusCode: statusCode,
            body: JSON.stringify({
                message,
