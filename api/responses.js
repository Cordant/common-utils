...
class Responses {
    ...
    static success(message, data) {
        index_1.Logger.internal.verbose('Responses.success');
        const result = Responses.response(200, message, data);
        index_1.Logger.internal.debug(result);
        return result;
    }
    /**
    ...
    static internalError(message, data) {
        index_1.Logger.internal.verbose('Responses.internalError');
    ...
    static notImplemented(message, data) {
        index_1.Logger.internal.verbose('Responses.notImplemented');
    ...
    static badRequest(message, data) {
        index_1.Logger.internal.verbose('Responses.badRequest');
    ...
    static unauthorized(message, data) {
        index_1.Logger.internal.verbose('Responses.unauthorized');
    ...
    static forbidden(message, data) {
        index_1.Logger.internal.verbose('Responses.forbidden');
    ...
    static notFound(message, data) {
        index_1.Logger.internal.verbose('Responses.notFound');
    ...
    static methodNotAllowed(message, data) {
        index_1.Logger.internal.verbose('Responses.methodNotAllowed');
    ...
    static error(statusCode, message, data) {
        index_1.Logger.internal.verbose('Responses.error');
        const response = Responses.response(statusCode, message, data);
        index_1.Logger.internal.error(statusCode, response);
        return response;
    }
    static response(statusCode, message, data) {
        index_1.Logger.internal.verbose('Responses.response');
        if (data) {
            index_1.Logger.internal.verbose('Returning body with the data parameter!');
            return {
        ...
        index_1.Logger.internal.verbose('Returning body without the data parameter!');
        return {
            statusCode: statusCode,
            body: JSON.stringify({
                message,
