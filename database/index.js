...
class Database {
    ...
    static getUserId(payload, options) {
        ...
        if (options === null || options === void 0 ? void 0 : options.userId) {
            index_2.Logger.debug('Overriding user id with options.userId!');
            index_2.Logger.sensitive(`User ID`, options.userId);
        ...
        if (payload === null || payload === void 0 ? void 0 : payload.federatedIdentityId) {
            ...
            index_2.Logger.deprecated('options.userId should be used instead of payload.federatedIdentityId!');
